...
import { FaBars, FaUserCog, FaClipboardList, FaChartLine, FaSignOutAlt } from 'react-icons/fa';
...
const AdminNavbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <Link to="/admin" className="navbar-brand">Panel Admin</Link>
            <button
                ...
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item">
                        <Link to="/admin/sales-report" className="nav-link">
                            <FaChartLine className="me-2" /> Ventas
                        </Link>
                    </li>
                    <li className="nav-item">
