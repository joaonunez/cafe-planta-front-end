...
const InventoryManagement = () => {
  ...
  const filteredProducts = store.adminProducts.filter(product => {
    const matchesName = nameFilter ? product.name.toLowerCase().startsWith(nameFilter.toLowerCase()) : true;
    const matchesCategory = categoryFilter ? product.product_category_id === parseInt(categoryFilter) : true;
